...
/**
 * err - Prints error messages determined by error code.
 * @error_code: following the error cods.
...
/**
 * mor_error - handles errors.
 * @error_code: when The error codes are the following:
 * (6) => When stack is empty for pint.
 * (7) => When stack is empty for pop.
